...
def scrape_all_wgi_to_mongo():
    ...
    if master_list:
        ...
        mongo_url = os.environ.get("MONGO_URI") or st.secrets["MONGO_URI"]
        ...
        print(f"Success! {len(records)} performances saved to MongoDB.")
    else:
        print("No data found.")
